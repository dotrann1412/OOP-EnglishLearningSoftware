...
string Date::_monthStr[12] = {"jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"};

int Date::getMonth(const string& str) {
	for(int i = 0; i < 12; ++i) 
...
string Date::getMonthStr(const int &month) {
